...
<html lang="en">
  ...
  <head>
    ...
    <link href="mobile-71782f0ff0cfdd557a96.min.css" rel="stylesheet"></head>
    <?php } else { ?>
    <link href="desktop-71782f0ff0cfdd557a96.min.css" rel="stylesheet"></head>
    <?php } ?>
  ...
  <body>
    ...
    <?php if ($detect->isMobile() && !$detect->isTablet()) { ?>
    <script type="text/javascript" src="mobile-71782f0ff0cfdd557a96.min.js"></script>
    <?php } else { ?>
    <script type="text/javascript" src="desktop-71782f0ff0cfdd557a96.min.js"></script>
    <?php } ?>
